...
#import "AcceleratedSensorModel.h"
#import "OTAManager.h"
...
/**
 ...
 @param model 回调的信息
 */
- (void)updateHeartRateback:(nullable JCBluetoothManager *) manager
              feedBackInfo:(HeartRateModel *)model;
/**
 获取心率血压的原始数据
 ...
 @param model 回调的信息
 */
- (void)updateHeartRateOriginalDataback:(nullable JCBluetoothManager *) manager
               feedBackInfo:(HeartRateModel *)model;
/**
 获取运动传感器的值
 ...
 @param model 回调的信息
 */
- (void)updateAcceleratedSensorDataback:(nullable JCBluetoothManager *) manager
                           feedBackInfo:(AcceleratedSensorModel *)model;

...
@interface OTAUpgradeViewController ()<UITableViewDelegate,UITableViewDataSource,UIDocumentInteractionControllerDelegate,JCBluetoothManagerDelegate,MBProgressHUDDelegate> {
...
- (void)viewWillDisappear:(BOOL)animated{
    ...
    if (self.progressValue>0 && self.progressValue < 100 ) {
        [[OTAManager shareOTAManager] cacelOTAUpdate:YES];
        //[[JCBluetoothManager shareCBCentralManager] reRoot];
    }
}
-(void)setView{
    // 文件管理器

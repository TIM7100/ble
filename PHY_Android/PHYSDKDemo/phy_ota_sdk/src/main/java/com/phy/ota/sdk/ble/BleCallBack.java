...
import com.phy.ota.sdk.beans.BleConstant;
...
import com.phy.ota.sdk.beans.Partition;
...
public class BleCallBack extends BluetoothGattCallback {
    ...
    public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
        ...
        if(uuid.equals(BleConstant.CHARACTERISTIC_OTA_INDICATE_UUID)){
            Log.d(TAG, HexString.parseStringHex(characteristic.getValue()));

...
/*********************************************************************
    GLOBAL VARIABLES
*/
perStatsByChan_t g_perStatsByChanTest1;

/*********************************************************************
    EXTERNAL VARIABLES
*/
volatile uint8_t g_current_advType1 = LL_ADV_CONNECTABLE_UNDIRECTED_EVT;
...
void check_PerStatsProcess1(void);

char* bdAddr2Str1( uint8* pAddr );
...
void OTATEST_Event_Init( uint8 task_id )
{
    ...
    LOG("======== RTC TEST ========\n");
    #endif
    LL_PLUS_PerStats_Init(&g_perStatsByChanTest1);
...
*/
uint16 OTATEST_Event( uint8 task_id, uint16 events )
{
...
static void peripheralStateNotificationCB( gaprole_States_t newState )
{
    ...
    case GAPROLE_STARTED:
    {
        ...
        #endif
        osal_memcpy(&str_addr[0],bdAddr2Str1(ownAddress),14);
...
static void simpleProfileChangeCB( uint8 paramID )
{
    ...
    case SIMPLEPROFILE_CHAR5:
        ...
        if (newValue[0] == 0xff)
        {
            ...
            g_current_advType1 = LL_ADV_CONNECTABLE_UNDIRECTED_EVT;
        ...
        else if(newValue[0]==0xfe)
        {
            ...
            // 1. reset
            // 2. reset advertisement
            g_current_advType1 = LL_ADV_NONCONNECTABLE_UNDIRECTED_EVT;
...
static void updateAdvData(void)
{
    ...
    // 5. update adv data
    // 5.1 update adv type
    uint8 advType = g_current_advType1;

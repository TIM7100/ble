...
static gattAttribute_t ota_AttrTbl[] =
{
    ...
    //OTA Command Value
    {
        {ATT_UUID_SIZE, ota_CommandUUID1},
        GATT_PERMIT_WRITE,
        0,
        &ota_CommandValue
    },
    ...
    //response Value
    {
        {ATT_UUID_SIZE, ota_ResponseUUID1},
        GATT_PERMIT_READ,
        0,
        &ota_ResponseValue
    },
...
CONST gattServiceCBs_t ota_ProfileCBs1 =
{
...
bStatus_t ota_app_AddService1(void)
{

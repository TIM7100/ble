...
#define   BLE_MAX_ALLOW_CONNECTION              1		                      				//����������Ӹ���
...
static void hal_rfphy_init(void)
{
    ...
    hal_rom_boot_init();																	//rom����������ʼ��
    NVIC_SetPriority((IRQn_Type)BB_IRQn,    IRQ_PRIO_REALTIME);								//�ж����ȼ�
    NVIC_SetPriority((IRQn_Type)TIM1_IRQn,  IRQ_PRIO_HIGH);     //ll_EVT
    NVIC_SetPriority((IRQn_Type)TIM2_IRQn,  IRQ_PRIO_HIGH);     //OSAL_TICK
    NVIC_SetPriority((IRQn_Type)TIM4_IRQn,  IRQ_PRIO_HIGH);     //LL_EXA_ADV
    //ble memory init and config
    ble_mem_init_config();																	//BLE��ʼ��
}
...
static void hal_init(void)
{
    ...
    xflash_Ctx_t cfg =
    {
        .spif_ref_clk   =   SYS_CLK_RC_32M,						//Flash����ӿڳ�ʼ��
...
int  main(void)
{
    ...
    g_system_clk = SYS_CLK_DLL_64M;//SYS_CLK_XTAL_16M;//SYS_CLK_DBL_32M;//SYS_CLK_XTAL_16M;//SYS_CLK_DLL_64M;

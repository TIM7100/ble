...
#define SAVE_FILE_INFO_ADDRESS          0x1100E000		//文件信息地址
#define SAVE_FLASH_START_ADDRESS		0x11024000UL    //文件存储起始地址
#define SAVE_FLASH_END_ADDRESS			((uint32)0x1103F000UL)    //文件存储结束地址

#define ONE_SECTOR_SIZE                 0x1000			//Flash 一个扇区的大小为0x1000 既 4096Byte
...
typedef enum {
	FILE_DOWNLOADED = 0,		//文件下载完成
	FILE_DOWNLOADING,			//文件下载中
	FILE_DOWNLOAD_ERR,          //文件下载错误
	FILE_AES_ING				//文件解密中
}FILE_STATE_t;
...
enum Type
{
    ...
    //以上的不能改,95U/97P[连供]加在后面,993/99W
    HP95UXLK,
    HP95UXLC,
    HP95UXLM,
    HP95UXLY,

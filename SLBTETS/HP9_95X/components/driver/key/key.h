...
//KEY Pin
#define KEY_BUTTON    P32
	
#define HAL_KEY_NUM                     1      //config key's number
#define HAL_KEY_EVENT                   0x0080 //assign short key event in your app event process
...
#define HAL_KEY_DEBOUNCD                100      //20ms
...
typedef struct gpio_key_t
{
    gpio_pin_e          pin;				//
    key_state_e         state;				
    idle_level_e        idle_level;			//空闲时的电平状态
...
void my_key_init(uint8_t task_id);
